...
if [ -r "${PLUGIN_ROOT:-${CODEX_HOME:-$HOME/.codex}/plugins/uberdev-codex}/lib/dispatch.sh" ]; then
  . "${PLUGIN_ROOT:-${CODEX_HOME:-$HOME/.codex}/plugins/uberdev-codex}/lib/dispatch.sh"
...
PERSONAS_YAML="${PLUGIN_ROOT:-${CODEX_HOME:-$HOME/.codex}/plugins/uberdev-codex}/skills/uberthink-pipeline/personas.yaml"
...
ISLANDS="$(grep -E '^ISLANDS=' "$RUN_DIR/run-state.txt" | tail -n1 | cut -d= -f2)"
PIPELINE_DIR="${PLUGIN_ROOT:-${CODEX_HOME:-$HOME/.codex}/plugins/uberdev-codex}/skills/uberthink-pipeline"
