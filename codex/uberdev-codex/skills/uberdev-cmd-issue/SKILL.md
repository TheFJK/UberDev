---
name: uberdev-cmd-issue
description: "Use when the user wants to create a GitHub issue with classification, codebase investigation, duplicate search, and label/scope validation. Invokable explicitly as $uberdev-cmd-issue. Original description: Create a GitHub issue with classification, codebase investigation, duplicate search, and label/scope validation"
---

# Codex bridge — read first

This skill was ported from a Claude Code slash command (`/issue`). On Codex:
...
Original argument hint: `<description> [--no-explore]`
