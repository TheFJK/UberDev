...
dispatch_backend: auto           # one of: auto, workflow, claude-bg, wezterm, background, codex — how /solve & /turbo run per-issue solvers (RFC 0004/0012/0015); default auto (-> workflow on Claude hosts, codex inside Codex); env override: UBERDEV_DISPATCH_BACKEND
...
`.codex/uberdev.local.md` first and then `.codex/uberdev.local.md`; a Codex
...
working directory, `PLUGIN_ROOT`, and `CODEX_HOME` are not validator
