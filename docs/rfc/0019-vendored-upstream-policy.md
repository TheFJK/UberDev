...
`plugins/uberdev/agents/` is a component. There are **77** of them: 20
third-party and 57 carrying `"origin": "uberdev"`. The originals are two-field
