...
description: Audits code comments and docstrings for accuracy against the code they describe, and for whether they will still be true a year from now. Dispatch when comments or docstrings have been added or changed, before finalising a PR, or when hunting comment rot in existing code.
model: inherit
color: green
---
