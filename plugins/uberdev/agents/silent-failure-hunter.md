...
description: Hunts silent failures in a change — swallowed exceptions, empty catch blocks, fallbacks that mask a real error, and handlers that report success anyway. Dispatch after work that touches error handling, catch blocks, or fallback logic.
model: inherit
color: yellow
---
