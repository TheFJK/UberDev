...
1. **Create Failing Test Case**
   ...
   - Use the `uberdev:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **uberdev:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **uberdev:verification-before-completion** - Verify fix worked before claiming success
