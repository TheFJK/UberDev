---
description: "Install short-form aliases (/issue, /solve, /turbo, /simplify, /review-pr, /merge, /dev, /testers, /ubergoal, /uberscan, /ubersimplify, /uberthink, /ubercluster) as one-way forwarders to /uberdev:<command>"
...
This command installs 13 aliases — one per row in the ALIASES table below.
