---
description: "Install short-form aliases (/issue, /solve, /turbo, /turbox, /simplify, /review-pr, /merge, /dev, /testers, /ubergoal, /uberscan, /ubersimplify, /uberthink, /ubercluster) as one-way forwarders to /uberdev:<command>"
...
This command installs 14 aliases — one per row in the ALIASES table below.
...
#   for canonical in issue solve turbo turbox simplify review-pr merge dev testers goal uberscan ubersimplify uberthink cluster; do …
