...
argument-hint: "<issue> [<issue> ...] [--max-cycles=N] [--max-parallel=N] [--barrier-timeout=N] [--review-grace-secs=N] [--only-mine] [--dry-run] [--resume] [--backend=<name>]"
...
**Usage:** `/uberdev:goal <issue> [<issue> ...] [--max-cycles=N] [--max-parallel=N] [--barrier-timeout=N] [--review-grace-secs=N] [--only-mine] [--dry-run] [--resume] [--backend=<name>]`
...
- **Already under bash ≥ 4** (e.g. CI, or an explicit `bash lib/goal-phase0.sh` run): proceed.
