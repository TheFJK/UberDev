---
description: "Remove short-form aliases (/issue, /solve, /turbo, /simplify, /review-pr, /merge, /dev, /testers, /ubergoal) installed by /uberdev:install-aliases"
...
SHORTS='issue solve turbo simplify review-pr merge dev testers ubergoal'
