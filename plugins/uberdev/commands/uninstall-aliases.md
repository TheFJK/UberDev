---
description: "Remove short-form aliases (/issue, /solve, /turbo, /turbox, /simplify, /review-pr, /merge, /dev, /testers, /ubergoal, /uberscan, /ubersimplify, /uberthink, /ubercluster) installed by /uberdev:install-aliases"
...
SHORTS='issue solve turbo turbox simplify review-pr merge dev testers ubergoal uberscan ubersimplify uberthink ubercluster'
