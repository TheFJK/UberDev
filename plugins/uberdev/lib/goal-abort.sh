...
# D5 — new members require an RFC amendment; #592 landed the latest one as
# D592a) and none of its fourteen members means "claims released by an
# out-of-band abort". Inventing a member here, or
