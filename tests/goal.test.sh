...
echo
echo "== G20: version bump locked (0.34.9) =="
assert_grep "$REPO_ROOT/plugins/uberdev/.claude-plugin/plugin.json" '"version": "0\.34\.9"'  "G20.plugin-json"
assert_grep "$REPO_ROOT/.claude-plugin/marketplace.json"            '"version": "0\.34\.9"'  "G20.marketplace-json"
assert_grep "$REPO_ROOT/README.md"                                  'version-0\.34\.9-blue'  "G20.readme-badge"
assert_grep "$REPO_ROOT/CHANGELOG.md"                               '## \[0\.34\.9\]'        "G20.changelog"
