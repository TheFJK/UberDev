...
expected_route_groups = {
    ...
    "deep": {"ci-code-fixer", "ci-rebase-handler", "code-fixer", "code-reviewer", "convention-compliance", "conflict-resolver", "findings-to-issues", "plan-reviewer", "plan-writer", "pr-test-analyzer", "research-security", "silent-failure-hunter", "spec-compliance-reviewer", "spec-reviewer", "spec-writer", "testers-adversarial-security", "type-design-analyzer", "uberthink-falsifier", "uberthink-synthesizer"},
